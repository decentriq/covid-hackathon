{ stdenv, pkgs, fetchurl, lib, callPackage, version, url, sha256, ... }:
let protobuf3_0 = callPackage ../protobuf3_0 {};
in stdenv.mkDerivation {
  ...
  buildCommand = ''
    ...
    patchelf \
      ...
      --set-rpath ${lib.makeLibraryPath (with pkgs; [ stdenv.cc.cc.lib openssl_1_1 protobuf3_0 ])}:$AESM_PATH \
    ...
    cat $AESM_PATH/aesmd.service \
     ...
     | sed "/Type=simple/a Environment=LD_LIBRARY_PATH=$AESM_PATH:${lib.makeLibraryPath [ pkgs.openssl_1_1 protobuf3_0 pkgs.curl ]}" \
